        ...
        <div className="w-full flex flex-col bg-slate-950/50 rounded-3xl border border-white/10 overflow-hidden backdrop-blur-xl">
            ...
            <div className="px-8 py-6 border-b border-white/10 bg-white/5 flex items-center justify-between shrink-0">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h2 className="text-2xl font-black italic tracking-tighter uppercase text-white leading-none">Disbursement Slip</h2>
                        <div className="flex items-center gap-2 mt-1.5">
                            ...
                            <span className="text-[10px] text-white/40 font-bold uppercase tracking-widest">Module DS-v4.2</span>
                        </div>
                    </div>
                </div>
                    ...
                    <form onSubmit={form.handleSubmit(onSubmit)} className="p-8 space-y-8">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                            <div className="lg:col-span-5 space-y-6">
                                <div className="flex items-center gap-2">
                                    ...
                                    <h3 className="text-[11px] font-black uppercase tracking-widest text-white">Business Unit Identification</h3>
                                </div>
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        <FormField control={form.control} name="agrivetBranch" render={({ field }) => (
                                            <FormItem className="space-y-1.5">
                                                <FormLabel className="text-[10px] font-black uppercase tracking-widest text-white/40 ml-1">Agrivet Branch</FormLabel>
                                        ...
                                        <FormField control={form.control} name="capexBussUnit" render={({ field }) => (
                                            <FormItem className="space-y-1.5">
                                                <FormLabel className="text-[10px] font-black uppercase tracking-widest text-white/40 ml-1">Capex Unit</FormLabel>
                                                <FormControl><Input {...field} className="h-10 bg-white/5 border-white/10 text-white rounded-xl text-xs uppercase" disabled={isReadOnly} /></FormControl>
                                            </FormItem>
                                        )} />
                                    </div>
                            ...
                            <div className="lg:col-span-7 space-y-6">
                                <div className="flex items-center gap-2">
                                    <div className="w-1 h-4 bg-primary rounded-full" />
                                    <h3 className="text-[11px] font-black uppercase tracking-widest text-white">Disbursement Target</h3>
                                </div>
                                <div className="bg-white/5 border border-white/10 p-6 rounded-3xl space-y-6">
                                    <div className="grid grid-cols-2 gap-6">
                                        ...
                                        <FormField control={form.control} name="payTo" render={({ field }) => (
                                            <FormItem className="space-y-1.5">
                                                <FormLabel className="text-[10px] font-black uppercase tracking-widest text-white/40 ml-1">Payee Node</FormLabel>
                                    ...
                                    <div className="grid grid-cols-2 gap-6">
                                        <FormField control={form.control} name="accountNumber" render={({ field }) => (
                                            <FormItem className="space-y-1.5">
                                                ...
                                                <FormControl><Input {...field} className="h-11 bg-white/5 border-white/10 text-white rounded-xl font-mono text-xs" disabled={isReadOnly} /></FormControl>
                                            </FormItem>
                                        )} />
                        ...
                        <div className="space-y-6">
                            <div className="flex items-center justify-between">
                                <div className="flex items-center gap-2">
                                    <div className="w-1 h-4 bg-primary rounded-full" />
                                    <h3 className="text-[11px] font-black uppercase tracking-widest text-white">Itemized Disbursement Matrix</h3>
                                </div>
                                <div className="flex items-center gap-4">
                                    ...
                                    {!isReadOnly && (
                                        <Button 
                                            type="button" 
                                            onClick={() => append({ qty: 1, unit: 'PC', particulars: '', amount: 0 })}
                                ...
                                <Table>
                                    <TableHeader className="bg-white/5">
                                        <TableRow className="border-white/5 hover:bg-transparent">
                                            <TableHead className="w-16 text-center text-[10px] font-black uppercase tracking-widest text-white/40">Qty</TableHead>
                                            <TableHead className="w-24 text-center text-[10px] font-black uppercase tracking-widest text-white/40">Unit</TableHead>
                                            <TableHead className="text-[10px] font-black uppercase tracking-widest text-white/40 px-6">Disbursement Particulars</TableHead>
                                            <TableHead className="w-36 text-right text-[10px] font-black uppercase tracking-widest text-white/40">Rate</TableHead>
                                            <TableHead className="w-40 text-right text-[10px] font-black uppercase tracking-widest text-white/40 px-6">Total</TableHead>
                                            ...
                                            <TableRow key={field.id} className="border-white/5 hover:bg-white/[0.02] transition-colors group">
                                                <TableCell className="py-3">
                                                    <FormField control={form.control} name={`items.${index}.qty`} render={({ field }) => (
                                                        <Input {...field} type="number" className="bg-transparent border-0 text-center font-black italic text-sm text-primary focus-visible:ring-0 shadow-none h-8" disabled={isReadOnly} />
                                                    )} />
                                                </TableCell>
                                                <TableCell className="py-3">
                                                    <FormField control={form.control} name={`items.${index}.unit`} render={({ field }) => (
                                                        <Input {...field} className="bg-transparent border-0 text-center font-bold text-[10px] uppercase text-white focus-visible:ring-0 shadow-none h-8" disabled={isReadOnly} placeholder="UNT" />
                                                    )} />
                                                </TableCell>
                                                <TableCell className="py-3 px-6">
                                                    <FormField control={form.control} name={`items.${index}.particulars`} render={({ field }) => (
                                                        <Input {...field} className="bg-transparent border-0 font-bold text-xs text-white/80 focus-visible:ring-0 shadow-none h-8" disabled={isReadOnly} placeholder="Add particular data node..." />
                                                    )} />
                                                </TableCell>
                                                ...
                                                <TableCell className="py-3 text-right font-black italic text-sm text-primary px-6">
                                    ...
                                    <FormField
                                        ...
                                        render={({ field }) => (
                                            <div className="flex items-center gap-3 max-w-2xl flex-1">
                                                <span className="text-[10px] font-black uppercase tracking-widest text-white/20 shrink-0">Lexical Mapping</span>
                                                <span className="text-[11px] font-black italic text-white/60 truncate">{field.value || "---"}</span>
                                            </div>
                                        )}
                                    />
                                    <div className="flex flex-col items-end">
                                        <span className="text-[10px] font-black text-white/20 uppercase tracking-widest">Aggregate Total</span>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 pt-8 border-t border-white/10 border-dashed">
                            {[
