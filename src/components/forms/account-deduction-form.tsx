        ...
        <div className="w-full flex flex-col bg-background/50 rounded-3xl border border-foreground/10 overflow-hidden backdrop-blur-xl">
            ...
            <div className="px-8 py-6 border-b border-foreground/10 bg-foreground/5 flex items-center justify-between shrink-0">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h2 className="text-2xl font-black italic tracking-tighter uppercase text-foreground leading-none">Account Deduction</h2>
                        <div className="flex items-center gap-2 mt-1.5">
                            ...
                            <span className="text-[10px] text-foreground/40 font-bold uppercase tracking-widest">Module ADR-v2.1</span>
                        </div>
                    </div>
                </div>
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                            <div className="lg:col-span-4 space-y-6">
                                <div className="flex items-center gap-2">
                                    ...
                                    <h3 className="text-[11px] font-black uppercase tracking-widest text-foreground">Requestor Identification</h3>
                                </div>
                                <div className="bg-foreground/5 border border-foreground/10 p-6 rounded-3xl space-y-4">
                                    <FormField control={form.control} name="requesterName" render={({ field }) => (
                                        <FormItem className="space-y-1.5">
                                            <FormLabel className="text-[10px] font-black uppercase tracking-widest text-foreground/40 ml-1">Personnel Node</FormLabel>
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        <FormField control={form.control} name="position" render={({ field }) => (
                                            <FormItem className="space-y-1.5">
                                                <FormLabel className="text-[10px] font-black uppercase tracking-widest text-foreground/40 ml-1">Designation</FormLabel>
                                        ...
                                        <FormField control={form.control} name="businessUnit" render={({ field }) => (
                                            <FormItem className="space-y-1.5">
                                                <FormLabel className="text-[10px] font-black uppercase tracking-widest text-foreground/40 ml-1">Branch/Dept</FormLabel>
                                                <FormControl><Input {...field} className="bg-foreground/5 border-foreground/10 text-foreground rounded-xl text-xs uppercase" disabled={isReadOnly} /></FormControl>
                                            </FormItem>
                                        )} />
                                    </div>
                            ...
                            <div className="lg:col-span-8 space-y-6">
                                <div className="flex items-center gap-2">
                                    <div className="w-1 h-4 bg-primary rounded-full" />
                                    <h3 className="text-[11px] font-black uppercase tracking-widest text-foreground">Protocol Configuration</h3>
                                </div>
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                                        ...
                                        <FormField control={form.control} name="chargeTo" render={({ field }) => (
                                            <FormItem className="space-y-1.5">
                                                ...
                                                <FormControl><Input {...field} className="bg-foreground/5 border-foreground/10 text-foreground rounded-xl text-xs uppercase" disabled={isReadOnly} placeholder="Entity Node..." /></FormControl>
                                            </FormItem>
                                        )} />
                                        <FormField control={form.control} name="accountNo" render={({ field }) => (
                                            <FormItem className="space-y-1.5">
                                                ...
                                                <FormControl><Input {...field} className="bg-foreground/5 border-foreground/10 text-foreground rounded-xl font-mono text-xs" disabled={isReadOnly} placeholder="REF-ID-000" /></FormControl>
                                            </FormItem>
                                        )} />
                                        <FormField control={form.control} name="purpose" render={({ field }) => (
                                            <FormItem className="md:col-span-2 space-y-1.5">
                                                <FormLabel className="text-[10px] font-black uppercase tracking-widest text-foreground/40 ml-1">Justification Protocol</FormLabel>
                                                <FormControl><Input {...field} className="bg-foreground/5 border-foreground/10 text-foreground rounded-xl text-xs uppercase" disabled={isReadOnly} placeholder="Deduction Rationale..." /></FormControl>
                                            </FormItem>
                                        )} />
                                        <FormField control={form.control} name="depositAccount" render={({ field }) => (
                                            <FormItem className="space-y-1.5">
                                                <FormLabel className="text-[10px] font-black uppercase tracking-widest text-foreground/40 ml-1">Target Account</FormLabel>
                        ...
                        <div className="space-y-6">
                            <div className="flex items-center justify-between">
                                <div className="flex items-center gap-2">
                                    ...
                                    <h3 className="text-[11px] font-black uppercase tracking-widest text-foreground">Adjustment Particulars Matrix</h3>
                                </div>
                                {!isReadOnly && (
                            ...
                            <div className="bg-foreground/5 border border-foreground/10 rounded-3xl overflow-hidden backdrop-blur-sm shadow-xl">
                                <Table>
                                    <TableHeader className="bg-foreground/5">
                                        <TableRow className="border-foreground/5 hover:bg-transparent">
                                            <TableHead className="w-16 text-center text-[10px] font-black uppercase tracking-widest text-foreground/40">ID</TableHead>
                                            <TableHead className="text-[10px] font-black uppercase tracking-widest text-foreground/40 px-6">Deduction Description</TableHead>
                                            <TableHead className="w-32 text-center text-[10px] font-black uppercase tracking-widest text-foreground/40">Quantity</TableHead>
                                            <TableHead className="w-40 text-right text-[10px] font-black uppercase tracking-widest text-foreground/40">Unit Rate</TableHead>
                                            <TableHead className="w-48 text-right text-[10px] font-black uppercase tracking-widest text-foreground/40 px-6">Line Protocol</TableHead>
                                    ...
                                    <TableBody>
                                        {fields.map((field, index) => (
                                            <TableRow key={field.id} className="border-foreground/5 hover:bg-foreground/[0.02] transition-colors group">
                                                <TableCell className="text-center text-[10px] font-black font-mono text-foreground/20">
                                                    {(index + 1).toString().padStart(2, '0')}
                                                </TableCell>
                                                <TableCell className="px-6">
                                                    <FormField control={form.control} name={`items.${index}.description`} render={({ field }) => (
                                                        <Input {...field} className="bg-transparent border-0 font-bold text-xs text-foreground/80 focus-visible:ring-0 shadow-none" disabled={isReadOnly} placeholder="Adjustment Data Node..." />
                                                    )} />
                                                </TableCell>
                                                <TableCell className="">
                                                    <FormField control={form.control} name={`items.${index}.quantity`} render={({ field }) => (
                                                        <Input {...field} type="number" className="bg-transparent border-0 text-center font-black italic text-sm text-destructive focus-visible:ring-0 shadow-none" disabled={isReadOnly} />
                                                    )} />
                                                </TableCell>
                                                ...
                                                <TableCell className="text-right font-black italic text-sm text-destructive px-6">
                                ...
                                <div className="bg-foreground/5 px-8 py-5 flex items-center justify-end border-t border-foreground/5">
                                    <div className="flex flex-col items-end">
                                        <span className="text-[10px] font-black text-foreground/20 uppercase tracking-widest">Aggregate Adjustment</span>
            ...
            <div className="px-8 py-6 border-t border-foreground/10 bg-foreground/5 flex items-center justify-between shrink-0">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <Button onClick={form.handleSubmit(onSubmit)} disabled={isSubmitting || isReadOnly} className="px-10 rounded-2xl bg-destructive hover:bg-destructive/90 text-foreground font-black uppercase tracking-widest text-[10px] shadow-[0_0_20px_rgba(239,68,68,0.3)] transition-all gap-2" >
