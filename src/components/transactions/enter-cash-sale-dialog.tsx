        ...
        <Popover open={open} onOpenChange={setOpen}>
            <PopoverTrigger asChild>
                <Button
                    ...
                    role="combobox"
                    aria-expanded={open}
                    className="w-full justify-between h-9 px-3 bg-white/5 border-white/10 text-white hover:bg-white/10 transition-all rounded-xl text-xs font-bold uppercase"
                >
                    {value
                        ? products.find((product) => product.sku === value)?.sku || value
                        : <span className="text-white/20">Select Item Code...</span>}
                    <ChevronsUpDown className="ml-2 h-4 w-4 shrink-0 opacity-50" />
                </Button>
            </PopoverTrigger>
            <PopoverContent className="w-[300px] p-0 bg-slate-900 border-white/10 shadow-2xl backdrop-blur-xl" align="start">
                <div className="flex flex-col p-2">
                    <div className="flex items-center px-3 mb-2">
                        <Input
                            placeholder="Filter node identification..."
                            value={search}
                            onChange={(e) => setSearch(e.target.value)}
                            className="h-10 bg-white/5 border-white/10 text-white text-xs placeholder:text-white/20 focus-visible:ring-0"
                        />
                    </div>
                    <ScrollArea className="h-72">
                        <div className="space-y-1 pr-4">
                            {filteredProducts.length === 0 ? (
                                <div className="py-6 text-center text-[10px] font-black uppercase tracking-widest text-white/20">No matching nodes</div>
                            ) : (
                                filteredProducts.map((product) => (
                                    <div
                                        ...
                                        className={cn(
                                            ...
                                            value === product.sku ? "bg-emerald-400/20 text-emerald-400" : "text-white/60"
                                        )}
                                        onClick={() => {
                                    ...
                                    >
                                        <div className="flex flex-col">
                                            ...
                                            <span className={cn(
                                                ...
                                                value === product.sku ? "text-emerald-400" : "text-white/40"
                                            )}>{product.name}</span>
                                        </div>
            ...
            <DialogContent className="max-w-6xl p-0 overflow-hidden bg-slate-950/98 border-white/10 backdrop-blur-3xl shadow-2xl flex flex-col h-[90vh]">
                ...
                <div className="px-8 py-6 border-b border-white/5 bg-white/5 flex items-center justify-between relative shrink-0">
                    ...
                    <div className="relative z-10 flex items-center gap-4">
                        ...
                        <div>
                            <DialogTitle className="text-2xl font-black italic tracking-tighter uppercase text-white leading-none">Point of Sale Protocol</DialogTitle>
                            <div className="flex items-center gap-2 mt-1.5">
                                ...
                                <span className="text-[10px] text-white/40 font-bold uppercase tracking-widest">Transaction Module v2.4</span>
                            </div>
                        </div>
                    </div>

                    <button 
                        onClick={() => closeDialog('enter-cash-sale')}
                ...
                <div className="flex-1 flex flex-col overflow-hidden">
                        ...
                        <div className="p-8 space-y-8">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                                <div className="bg-white/5 border border-white/10 p-6 rounded-2xl backdrop-blur-sm relative overflow-hidden group">
                                    ...
                                    <p className="text-[10px] font-black uppercase tracking-widest text-white/40 mb-1">Settlement Total</p>
                                ...
                                <div className="bg-white/5 border border-white/10 p-6 rounded-2xl backdrop-blur-sm relative overflow-hidden group">
                                    ...
                                    <p className="text-[10px] font-black uppercase tracking-widest text-white/40 mb-1">Active Nodes</p>
                                ...
                                <div className="md:col-span-2 bg-white/5 border border-white/10 p-6 rounded-2xl backdrop-blur-sm flex items-center justify-between">
                                    <div className="space-y-1">
                                        <p className="text-[10px] font-black uppercase tracking-widest text-white/40">Sales Intelligence</p>
                                        <p className="text-xs font-bold text-white uppercase italic tracking-tight opacity-60">Revenue capture from direct retail channels.</p>
                                    </div>
                            ...
                            <div className="space-y-6">
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center gap-2">
                                        ...
                                        <h3 className="text-[11px] font-black uppercase tracking-widest text-white">Item Allocation Matrix</h3>
                                    </div>
                                    <Button 
                                        onClick={addItemRow}
                                        variant="outline" 
                                    ...
                                    <Table>
                                        <TableHeader className="bg-white/5">
                                            <TableRow className="border-white/5 hover:bg-transparent">
                                                <TableHead className="w-24 text-[10px] font-black uppercase tracking-widest text-white/40 h-12">QTY</TableHead>
                                                <TableHead className="w-64 text-[10px] font-black uppercase tracking-widest text-white/40 h-12">Item Code</TableHead>
                                                <TableHead className="text-[10px] font-black uppercase tracking-widest text-white/40 h-12">Description Particulars</TableHead>
                                                <TableHead className="w-32 text-[10px] font-black uppercase tracking-widest text-white/40 h-12 text-right">Unit Value</TableHead>
                                                <TableHead className="w-40 text-[10px] font-black uppercase tracking-widest text-white/40 h-12 text-right">Node Total</TableHead>
                                                <TableHead className="w-16"></TableHead>
                                            </TableRow>
                                        </TableHeader>
                                        <TableBody>
                                            {items.map((item) => (
                                                <TableRow key={item.id} className="border-white/5 hover:bg-white/[0.02] group transition-colors">
                                                    <TableCell className="py-4">
                                                        <Input
                                                            type="number"
                                                            className="bg-transparent border-0 shadow-none text-white font-black italic focus:ring-0 h-8 text-sm"
                                                            value={item.qty}
                                                    ...
                                                    <TableCell className="py-4">
                                                        <div className="h-8 flex items-center px-3 border-0 bg-transparent text-white/60 text-xs font-bold uppercase italic tracking-tight truncate">
                                                            {item.description || "Awaiting Identification..."}
                                                        </div>
                                                    </TableCell>
                                                    <TableCell className="py-4 text-right">
                                                        <span className="font-mono text-xs text-white/40">₱{item.unitPrice.toLocaleString(undefined, { minimumFractionDigits: 2 })}</span>
                                                    </TableCell>
                                                    <TableCell className="py-4 text-right">
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                                <div className="space-y-6">
                                    ...
                                    <div className="bg-white/5 border border-white/10 p-6 rounded-2xl space-y-6">
                                        <div className="space-y-2">
                                            <Label className="text-[10px] font-black uppercase tracking-widest text-white/40">Deposit Channel</Label>
                                        ...
                                        <div className="space-y-2">
                                            <Label className="text-[10px] font-black uppercase tracking-widest text-white/40">Assigned Agent</Label>
                                ...
                                <div className="space-y-6">
                                    <div className="flex items-center gap-2">
                                        ...
                                        <h3 className="text-[11px] font-black uppercase tracking-widest text-white">Journal Commentary</h3>
                                    </div>
                                    <div className="bg-white/5 border border-white/10 p-6 rounded-2xl space-y-4">
                                        <div className="space-y-2">
                                            <Label className="text-[10px] font-black uppercase tracking-widest text-white/40">Public Particulars</Label>
                                            <Textarea
                                                placeholder="[Internal receipt notes...]"
                                                className="bg-white/5 border-white/10 text-white rounded-xl min-h-[68px] resize-none text-xs placeholder:text-white/10"
                                                value={comments}
                                                onChange={(e) => setComments(e.target.value)}
                                            />
                                        </div>
                                        <div className="space-y-2">
                                            <Label className="text-[10px] font-black uppercase tracking-widest text-white/40">Audit Intelligence (Private)</Label>
                                            <Textarea
                                                placeholder="[Internal risk assessment notes...]"
                                                className="bg-white/5 border-white/10 text-white rounded-xl min-h-[68px] resize-none text-xs placeholder:text-white/10"
                    ...
                    <div className="px-8 py-6 border-t border-white/5 bg-white/5 flex items-center justify-between shrink-0">
                        <div className="flex items-center gap-10">
                            <div className="flex flex-col">
                                <span className="text-[10px] font-black text-white/20 uppercase tracking-widest">Protocol Validation</span>
                                <div className="flex items-center gap-2 mt-1">
                                    <div className={cn(
                                        "w-2 h-2 rounded-full",
                                        total > 0 ? "bg-emerald-400 animate-pulse" : "bg-white/10"
                                    )} />
                            ...
                            <div className="flex flex-col">
                                <span className="text-[10px] font-black text-white/20 uppercase tracking-widest">Aggregate Value</span>
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <div className="flex rounded-xl overflow-hidden shadow-lg shadow-emerald-400/20">
                                <Button 
                                    className="h-12 px-8 rounded-none bg-emerald-400 hover:bg-emerald-400/90 text-black font-black uppercase tracking-widest text-[10px] transition-all gap-2"
                                >
                                ...
                                <DropdownMenu>
                                    <DropdownMenuTrigger asChild>
                                        <Button variant="outline" size="icon" className="h-12 w-10 rounded-none border-0 bg-emerald-500 hover:bg-emerald-600 text-black border-l border-black/10">
