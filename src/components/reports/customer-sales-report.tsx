...
export default function CustomerSalesReport() {
    ...
    const dialogData = getDialogData('customer-sales-report');
    const fromDate = dialogData?.fromDate || new Date();
    const toDate = dialogData?.toDate || new Date();

    return (
        <Dialog open={openDialogs['customer-sales-report']} onOpenChange={() => closeDialog('customer-sales-report')}>
            <DialogContent className="max-w-4xl h-[90vh] flex flex-col p-0 gap-0">
                    ...
                    <Menubar className="rounded-none border-x-0 border-b border-t-0">
                        <MenubarMenu>
                            ...
                            <MenubarContent>
                                ...
                                <MenubarSeparator />
                                <MenubarItem onClick={() => closeDialog('customer-sales-report')}>Close</MenubarItem>
                            </MenubarContent>
                        </MenubarMenu>
                        <MenubarMenu>
                ...
                <DialogHeader className="p-6 text-left">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <DialogTitle className="text-xl font-bold text-white text-left">Customer Sales Report</DialogTitle>
                        ...
                        <TableBody>
                            <TableRow>
                                <TableCell colSpan={5} className="h-32 text-center text-muted-foreground italic">
                                    Customer Sales Data Placeholder
                                </TableCell>
                            </TableRow>
                        </TableBody>
                    </Table>
