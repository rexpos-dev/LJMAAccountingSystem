...
export default function InventoryReportDialog() {
    ...
    const handleRunReport = () => {
        setDialogData('inventory-report' as any, { reportDate });
        closeDialog('inventory-report-dialog' as any);
        openDialog('inventory-report' as any);
    };

    return (
        <Dialog open={openDialogs['inventory-report-dialog'] || false} onOpenChange={() => closeDialog('inventory-report-dialog' as any)}>
            <DialogContent className="max-w-md">
                ...
                <div className="p-6 space-y-4">
                    ...
                    <div className="pt-4 border-t flex justify-end gap-2">
                        <Button variant="outline" onClick={() => closeDialog('inventory-report-dialog')}
                        >
                            Cancel
                        </Button>
