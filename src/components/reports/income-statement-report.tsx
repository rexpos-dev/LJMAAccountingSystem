            ...
            <DialogContent className="max-w-4xl h-[90vh] flex flex-col p-0 gap-0">
                    ...
                    <Menubar className="rounded-none border-x-0 border-b border-t-0">
                        <MenubarMenu>
                            ...
                            <MenubarContent>
                                ...
                                <MenubarSeparator />
                                <MenubarItem onClick={() => closeDialog('income-statement-report')}>Close</MenubarItem>
                            </MenubarContent>
                        </MenubarMenu>
                        <MenubarMenu>
                ...
                <DialogHeader className="p-6 text-left">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <DialogTitle className="text-xl font-bold text-white text-left">Income Statement</DialogTitle>
