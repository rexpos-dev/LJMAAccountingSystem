...
export default function TaxReportDialog() {
    ...
    const handleRunReport = () => {
        setDialogData('tax-report' as any, { fromDate, toDate });
        closeDialog('tax-report-dialog' as any);
        openDialog('tax-report' as any);
    };

    return (
        <Dialog open={openDialogs['tax-report-dialog'] || false} onOpenChange={() => closeDialog('tax-report-dialog' as any)}>
            <DialogContent className="max-w-md">
                <DialogHeader>
                    <DialogTitle>VAT/Sales Tax Report</DialogTitle>
                </DialogHeader>
                <div className="p-6 space-y-4">
                    ...
                    <div className="pt-4 border-t flex justify-end gap-2">
                        <Button variant="outline" onClick={() => closeDialog('tax-report-dialog' as any)}
                        >
                            Cancel
                        </Button>
