...
export default function CashFlowReport() {
    ...
    const dialogData = getDialogData('cash-flow-report');
    const fromDate = dialogData?.fromDate || new Date();
    const toDate = dialogData?.toDate || new Date();

    return (
        <Dialog open={openDialogs['cash-flow-report']} onOpenChange={() => closeDialog('cash-flow-report')}>
            <DialogContent className="max-w-4xl h-[90vh] flex flex-col p-0 gap-0">
                    ...
                    <Menubar className="rounded-none border-x-0 border-b border-t-0">
                        <MenubarMenu>
                            ...
                            <MenubarContent>
                                ...
                                <MenubarSeparator />
                                <MenubarItem onClick={() => closeDialog('cash-flow-report')}>Close</MenubarItem>
                            </MenubarContent>
                        </MenubarMenu>
                        <MenubarMenu>
                ...
                <DialogHeader className="p-6">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <DialogTitle className="text-xl font-bold text-white text-left">Cash Flow Statement</DialogTitle>
                ...
                <ScrollArea className='flex-1 px-6'>
                    <Table>
                        ...
                        <TableBody>
                            <TableRow className="font-bold text-white bg-secondary/20">
